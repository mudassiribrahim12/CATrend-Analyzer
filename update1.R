...
server <- function(input, output, session) {
  ...
  # Test results - CONSISTENT OUTPUT WITH PROPER INTERPRETATION BASED ON Z-SIGN
  output$test_results <- renderPrint({
    ...
    if (results$is_increasing) {
      cat("p-value (one-sided, increasing):", format(one_sided_p, digits = 4), "\n")
      cat("p-value (two-sided):", format(two_sided_p, digits = 4), "\n")
    } else if (results$is_decreasing) {
      cat("p-value (one-sided, decreasing):", format(one_sided_p, digits = 4), "\n")
      cat("p-value (two-sided):", format(two_sided_p, digits = 4), "\n")
    } else {
      cat("p-value (two-sided):", format(two_sided_p, digits = 4), "\n")
    }
        ...
        rmd_content <- paste0(
          ...
          if (results$is_increasing && one_sided_p < 0.05) {
            paste0("There is a statistically significant **INCREASING** trend in the proportion of **'", 
                   first_dep_level, "'** across the ordered levels of **", 
                   ind_var, "** (Z = ", format(z_stat, digits = 3), ", one-sided p = ", format(one_sided_p, digits = 4), "). ",
            ...
            paste0("There is a statistically significant relationship between **", 
                   dep_var, "** and **", ind_var, "** (two-sided p = ", format(two_sided_p, digits = 4), "). ",
            ...
            paste0("No statistically significant trend was detected in the proportion of **",
                   ...
                   ind_var, "** (p = ", format(one_sided_p, digits = 4), "). ",
